export const data = {
    ...
    "data": {
        ...
        "226631": {
            "name": "Stridebreaker",
            "description": "<mainText><stats><nerfedStat>60</nerfedStat> Attack Damage<br><attention>20%</attention> Attack Speed<br><attention>375</attention> Health</stats><br><br><br><li><passive>Heroic Gait:</passive> Dealing physical damage grants <speed>20 Move Speed</speed> for 3 seconds.<br><br><rarityMythic>Mythic Passive:</rarityMythic> Grants all other <rarityLegendary>Legendary</rarityLegendary> items <attention>2%</attention> Move Speed.<br><br><active>ACTIVE</active> (0s)<br><active>Breaking Shockwave</active><br>Deal <physicalDamage>0 phyiscal damage</physicalDamage> and <status>Slow</status> nearby enemies by 40% and gain <speed>40% bonus Move Speed</speed> per champion hit that decays over 3 seconds. Can move while casting.</mainText>",
            "colloq": "",
            "plaintext": "",
            "into": [
                "227016"
        ...
        "227029": {
            "name": "Youmuu's Wake",
            "description": "<mainText><stats><ornnBonus>75</ornnBonus> Attack Damage<br><ornnBonus>26</ornnBonus> Lethality</stats><br><br><passive>Haunt</passive> <br>Gain <speed>{{Item_Melee_Ranged_Split_Dynamic}} Move Speed</speed> while out of combat.<br>{{ Item_OnActivation }} {{ Item_Cooldown }}<br><active>Wraith Step</active><br>Gain <speed>Move Speed</speed> and <keyword>Ghosting</keyword>.</mainText>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "223142"
        ...
        "3508": {
            "name": "Essence Reaver",
            "description": "<mainText><stats><attention>60</attention> Attack Damage<br><attention>20%</attention> Critical Strike Chance<br><attention>20</attention> Ability Haste</stats><br><br><passive>Spellblade</passive><br>After using an Ability, your next Attack deals additional damage and restores Mana.</mainText>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "3057",
        ...
        "6631": {
            "name": "Stridebreaker",
            "description": "<mainText><stats><attention>50</attention> Attack Damage<br><attention>30%</attention> Attack Speed<br><attention>450</attention> Health</stats><br><br><passive>Cleave</passive><br>Attacks deal <physicalDamage>{{ Item_Melee_Ranged_Split_Dynamic }} physical damage</physicalDamage> to nearby enemies.<br><br><passive>Temper</passive><br>Dealing <physicalDamage>physical damage</physicalDamage> grants <speed>20 Move Speed</speed> for 2 seconds.{{ Item_OnActivation }} {{ Item_Cooldown }}<br><active>Breaking Shockwave</active><br>Deal <physicalDamage>0 phyiscal damage</physicalDamage> and <status>Slow</status> nearby enemies by 35% and gain <speed>35% bonus Move Speed</speed> per champion hit that decays over 3 seconds. Can move while casting.</mainText>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "3077",
        ...
        "6676": {
            "name": "The Collector",
            "description": "<mainText><stats><attention>55</attention> Attack Damage<br><attention>20%</attention> Critical Strike Chance<br><attention>16</attention> Lethality</stats><br><br><passive>Death</passive><br>Your damage executes champions that are below 5% Health.<br><br><passive>Taxes</passive><br>Champion kills grant an additional <gold>25 gold</gold>.</mainText>",
            "colloq": "",
            "plaintext": "",
            "from": [
                "3134",
